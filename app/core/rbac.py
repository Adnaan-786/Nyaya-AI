...
PERMISSIONS: dict[str, set[Role]] = {
    ...
    "casework.write": {Role.FIRM_ADMIN, Role.LAWYER, Role.INTERN},
    "casework.read": {Role.FIRM_ADMIN, Role.LAWYER, Role.INTERN},
    "documents.write": {Role.FIRM_ADMIN, Role.LAWYER, Role.INTERN},
    "documents.read": {Role.FIRM_ADMIN, Role.LAWYER, Role.INTERN},
    ...
    "ai.jobs.read": {Role.FIRM_ADMIN, Role.LAWYER, Role.INTERN},
